...
\textbf{Phenolic Resin (M3)} — phenol-formaldehyde thermosetting resins have been
...
\textbf{Polysiloxane Composite (M6)} — 2.5D SiO$_{2}$-fibre/SiO$_{2}$-matrix
composites (McDermott et al.\ 2022) combine ablative performance with structural
integrity. A char yield of 86.5\% and the formation of an SiOC ceramic matrix
maintain structural function at temperatures above 1400\,°C. Room-temperature
properties: UTS = 182\,MPa, $E$ = 45.5\,GPa, density = 1320\,kg/m$^{3}$,
$K_{\mathrm{IC}}$ = 2.52\,MPa$\,\mathrm{m}^{0.5}$. AO resistance is inherently
high due to the silica-rich surface.
...
\textbf{Polysiloxane Composite~II (M13)} — a second class of polysiloxane-matrix
composites with ceramic-fibre reinforcement achieves UTS = 150\,MPa,
...
the modulus of aluminium alloys at one-third the density. Polysiloxane composite
...
to 1550\,kg/m$^{3}$ (phenolic composite, M12). The narrow density range is a
...
\subsubsection*{3. Polysiloxane Composite (M6) — Ablative-Structural Hybrid}
...
\subsubsection*{4. Carbon-Fibre/Phenolic Composite (M12) — Primary High-Heat-Load TPS}
